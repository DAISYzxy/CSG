...
class Index {
 public:
  ...
  virtual void Build(size_t dimension, size_t n, const float *data, const Parameters &parameters, const char *filename) = 0;
 ...
 protected:
  ...
  const float *data1_ = nullptr;
  const float *data2_ = nullptr;
  size_t nd_;
  bool has_built;
  Distance* distance_ = nullptr;
  Distance* distance2_ = nullptr;
};
